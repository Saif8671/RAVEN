...
export function FindingCard({ f, idx }) {
  ...
  const getSevColor = (s) => 
    s === "Critical" ? "var(--threat)" : 
    s === "High" ? "#ffcc99" : 
    s === "Medium" ? "#fce8b2" : "var(--teal)";

  const getSevBg = (s) => 
    s === "Critical" ? "rgba(255, 180, 171, 0.15)" : 
    s === "High" ? "rgba(255, 204, 153, 0.1)" : 
    s === "Medium" ? "rgba(252, 232, 178, 0.1)" : "rgba(168, 240, 221, 0.1)";
  ...
  return (
    <motion.div 
      ...
      style={{
        ...
        borderRadius: 8, overflow: "hidden", marginBottom: 16, transition: "all 0.3s"
      }}
    >
      <div 
      ...
      >
        <div style={{
          padding: "6px 12px", borderRadius: 4, fontFamily: "var(--font-mono)", fontSize: 11,
          fontWeight: 600, letterSpacing: "0.05em", color: getSevColor(f.severity), background: getSevBg(f.severity),
        ...
        {expanded && (
          ...
          >
            <div style={{ padding: "0 32px 32px", borderTop: "1px solid var(--border2)", marginTop: 16, paddingTop: 24 }}>
              <div style={{ color: "var(--accent)", fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 16 }}>How to fix it:</div>
